    ...
    <div class=" main position-relative">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#crateOrderModal" style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">
            ...
            <div style="margin-bottom: -12px;" class="-m-2 hide-scroll-bar d-flex mt-2 gap-1 overflow-x-scroll ">
                <span onclick="resetFilter()" class="filter-btn active cursor-pointer no-space-wrap bg-secondary-subtle fs-7 rounded rounded-pill px-2 p-1">All</span>
                <span onclick="dateFilter(null,7)" class="filter-btn cursor-pointer no-space-wrap bg-secondary-subtle fs-7 rounded rounded-pill px-2 p-1">last
                    7 days</span>
                <span onclick="dateFilter(null,30)" class="filter-btn cursor-pointer no-space-wrap bg-secondary-subtle fs-7 rounded rounded-pill px-2 p-1">last
                    30 days</span>
                <span class="filter-btn cursor-pointer no-space-wrap bg-secondary-subtle fs-7 rounded rounded-pill px-2 p-1 d-flex gap-2">
