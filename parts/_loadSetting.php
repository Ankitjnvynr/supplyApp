                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input class="form-control form-control-sm" id="name" name="name" type="text"
                            aria-label=".form-control-sm example" value="<?php echo ucwords(strtolower($userName)) ?>"
                            required>
                    </div>
                    <div class="mb-3">
                        <label for="phone" class="form-label-sm">Phone</label>
                        <input class="form-control form-control-sm" id="phone" name="phone" type="text" value="<?php echo $phone ?>"
                            aria-label=".form-control-sm example" required>
                    </div>
                    <div class="mb-3">
                        <label for="state" class="form-label-sm">State</label>
                        <input class="form-control form-control-sm" id="state" name="state" type="text" value="<?php echo $state ?>"
                            aria-label=".form-control-sm example" required>
                    </div>
                    <div class="mb-3">
                        <label for="district" class="form-label-sm">District</label>
                        <input class="form-control form-control-sm" id="district" name="district" type="text" value="<?php echo $district ?>"
                            aria-label=".form-control-sm example" required>
                    </div>
                    <div class="mb-3">
                        <label for="tehsil" class="form-label-sm">Tehsil</label>
                        <input class="form-control form-control-sm" id="tehsil" name="tehsil" type="text" value="<?php echo $tehsil ?>"
                            aria-label=".form-control-sm example" required>
                    </div>
                    <div class="mb-3">
                        <label for="city" class="form-label-sm">City/Village</label>
                        <input class="form-control form-control-sm" id="city" name="city" type="text" value="<?php echo $city ?>"
                            aria-label=".form-control-sm example" required>
                    </div>
                    <div class="mb-3">
                        <label for="pin_code" class="form-label-sm">Pin Code</label>
                        <input class="form-control form-control-sm" id="pin_code" name="pin_code" type="text" value="<?php echo $pin; ?>"
                            aria-label=".form-control-sm example" required>
                    </div>
                    <div class="mb-3">
...
<div class="container-fluid py-1 mb-3" style="background-color:var(--clr2)">
    <div class="editprofilebtn float-end fw-bold text-success">
        <button data-bs-toggle="modal" data-bs-target="#EditInfoModal" class="btn">Edit <i
