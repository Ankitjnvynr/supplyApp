        ...
        <div class="choose-user-type-box d-flex gap-4 flex-column align-items-center justify-content-center ">
            <form class="w-100 rounded shadow p-2" action="" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control form-control-sm" id="name" name="name" type="text" aria-label=".form-control-sm example" required>
                </div>
                <div class="mb-3">
                    <label for="phone" class="form-label-sm">Phone</label>
                    <input class="form-control form-control-sm" id="phone" name="phone" type="text" aria-label=".form-control-sm example" required>
                </div>
                <div class="mb-3">
                    <label for="state" class="form-label-sm">State</label>
                    <input class="form-control form-control-sm" id="state" name="state" type="text" aria-label=".form-control-sm example" required>
                </div>
                <div class="mb-3">
                    <label for="district" class="form-label-sm">District</label>
                    <input class="form-control form-control-sm" id="district" name="district" type="text" aria-label=".form-control-sm example" required>
                </div>
                <div class="mb-3">
                    <label for="tehsil" class="form-label-sm">Tehsil</label>
                    <input class="form-control form-control-sm" id="tehsil" name="tehsil" type="text" aria-label=".form-control-sm example" required>
                </div>
                <div class="mb-3">
                    <label for="city" class="form-label-sm">City/Village</label>
                    <input class="form-control form-control-sm" id="city" name="city" type="text" aria-label=".form-control-sm example" required>
                </div>
                <div class="mb-3">
                    <label for="pin_code" class="form-label-sm">Pin Code</label>
                    <input class="form-control form-control-sm" id="pin_code" name="pin_code" type="text" aria-label=".form-control-sm example" required>
                </div>
                <div class="mb-3">
                    <label for="shop_name" class="form-label-sm">Shop Name</label>
                    <input class="form-control form-control-sm" id="shop_name" name="shop_name" type="text" aria-label=".form-control-sm example" required>
                </div>
