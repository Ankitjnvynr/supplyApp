...
<form class="shadow p-3 rounded needs-validation" novalidate method="POST" action="">
    ...
    <div class="mb-3" <?php echo $step1 ? '' : 'hidden' ?>>
        ...
        <input autocomplete="false" aria-autocomplete="false" type="email" class="form-control" id="userEmail" name="userEmail" aria-describedby="emailHelp" value="<?php echo isset($_POST['userEmail']) ? $_POST['userEmail'] : '' ?>" required>
    ...
    <div class="text-center">
        <button id="" type="submit" name="<?php echo $step1 ? 'Next' : 'Signup' ?>" class="btn btn-success text-center" fdprocessedid="vw48xs" style="width: 100%;"><?php echo $step1 ? 'Next ->' : 'Signup' ?></button>
    </div>
