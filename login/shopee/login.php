...
<form class="w-100 rounded shadow p-3" action="" method="POST">
    ...
    <p class="m-0 mt-3">Forgot Password ? <a class="text-success fw-bold p-0 m-0" href="../shopee?signup">Reset </a></p>
    <p class="m-0">Not registered yet, <a class="text-success fw-bold p-0 m-0" href="../shopee?signup">Sign Up</a></p>
</form>